...
export const insertDish = (dishName, description, price, photoUri, category) => {
  return new Promise((resolve, reject) => {
    db.transaction(
      (tx) => {
        tx.executeSql(
...
export const checkMenuTableAndPopulateData = async () => {
...
export const filterMenuItems = (categories, searchInput) => {
  return new Promise((resolve, reject) => {
    try {
      const queryArray = [];
